...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    public MyAdapter(Context context,String[] myDataset,String[] myDataset1) {
        mDataset = myDataset;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View v) {
            ...
            mTextView1=(TextView) v.findViewById(R.id.tv_text);
    ...
    private  void opendetail(String name,String message)
    {
        Intent i= new Intent(context,card3.class);

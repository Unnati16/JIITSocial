...
public class NewsFeed8 extends Fragment {
    ...
    public class GetDataTask extends AsyncTask<String, Void, String> {
               ...
               // Toast toast = Toast.makeText(getActivity(), "Check Internet Connection", Toast.LENGTH_SHORT);
                ...
                try {
                    ...
                    for(int i=0;i<jarr.length();i++)
                    {
                        ...
                        if(hub.equals("Parola.LiteraryHub"))
                        {
                            str[i]="PAGE TURNER SOCIETY";
                            st1[i]=R.drawable.pts;
                        }
        ...
        public String ConvertData() {
            ...
            try {
                root.put("hub","Parola.LiteraryHub");
    ...
    public void onResume() {
        ...
        //toast.show();
        new GetDataTask().execute("http://192.168.43.144:3000/api/feed1");
    }
}

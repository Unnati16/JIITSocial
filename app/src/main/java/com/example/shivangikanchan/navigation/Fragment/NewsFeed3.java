...
public class NewsFeed3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        new com.example.shivangikanchan.navigation.Fragment.NewsFeed3.GetDataTask().execute("http://192.168.43.31:3000/api/feed1");

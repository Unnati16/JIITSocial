...
public class NewsFeed extends Fragment {
    ...
    public void saveData(String s) {
        SharedPreferences loginData = this.getActivity().getSharedPreferences("Newsfeed", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = loginData.edit();
        editor.putString("data4", s);
        editor.apply();
    }
    public String getData1() {
        SharedPreferences loginData = this.getActivity().getSharedPreferences("NewsInfo", Context.MODE_PRIVATE);
        String stat = loginData.getString("data4", "");
        return stat;
    }
    @Override
